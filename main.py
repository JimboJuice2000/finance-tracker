...
def add():
    CSV.initialize_csv()
    date=get_date("Enter the date of the transcaction (dd-mm-yyyy). Press ENTER for today's date: ", allow_default=True)
    amount=get_amount()
...
def main():
    while True:
        ...
        print('2.Transaction History and Summary for given date range')
        print('3.Exit')
        ...
        if choice =='1':
            ...
            if input("GRAPHICAL REPRESENTATION? (y/n): ").lower() == 'y':
